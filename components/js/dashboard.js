...
<div class="nav-right">
  ...
  <input type="text" class="search-input input-binder" placeholder="Search something here..."><div class="nav-searchw"><svg width="15" height="15" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
